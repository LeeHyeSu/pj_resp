...
def prep(basepath, targetpath, name, resample=True):
...
basepath = '/workspace/pj_resp/ssast/src/pretrain/data/chest_wall/audio/'
targetpath = '/workspace/pj_resp/ssast/src/pretrain/data/chest_wall/audio_16k/'
name = 'chest_wall'
prep(basepath, targetpath, name, resample=False)