...
# print mean, std (from Patch-mix paper)
# mean, std = dataloader.get_mean_and_std(dataloader.AudioDataset(args.data_train, label_csv=args.label_csv, audio_conf=audio_conf))
# print('get_mean_and_std... mean :', mean, 'std :', std)
...
if args.data_eval != None:
    ...
    stats, _ = validate(audio_model, val_loader, args, 'valid_set', best_score)
    ...
    stats, _ = validate(audio_model, eval_loader, args, 'eval_set', best_score)
